...
/// Keyed by a storage slot, so this uses
/// [`FixedKeyHasher`](primitives::FixedKeyHasher) rather than the default foldhash. See
/// [`StorageKeyMap`].
...
/// Keyed by a storage slot; see [`StorageWithOriginalValues`] for the hasher.
